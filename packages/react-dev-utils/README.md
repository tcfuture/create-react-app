...
var path = require('path');
var HtmlWebpackPlugin = require('html-webpack-plugin');
var InlineChunkHtmlPlugin = require('@tcfuture/react-dev-utils/InlineChunkHtmlPlugin');
...
```js
var path = require('path');
var ModuleScopePlugin = require('@tcfuture/react-dev-utils/ModuleScopePlugin');
...
```js
var path = require('path');
var WatchMissingNodeModulesPlugin = require('@tcfuture/react-dev-utils/WatchMissingNodeModulesPlugin');
...
```js
var path = require('path');
var checkRequiredFiles = require('@tcfuture/react-dev-utils/checkRequiredFiles');
...
```js
var clearConsole = require('@tcfuture/react-dev-utils/clearConsole');
...
```js
const eslintFormatter = require('@tcfuture/react-dev-utils/eslintFormatter');
...
} = require('@tcfuture/react-dev-utils/FileSizeReporter');
...
var formatWebpackMessages = require('@tcfuture/react-dev-utils/formatWebpackMessages');
...
```
  const printBuildError = require('@tcfuture/react-dev-utils/printBuildError')
  try {
    build()
  } catch(e) {
...
```js
var getProcessForPort = require('@tcfuture/react-dev-utils/getProcessForPort');
...
```js
var path = require('path');
var openBrowser = require('@tcfuture/react-dev-utils/openBrowser');
...
module.exports = {
  ...
  entry: [
    ...
    '@tcfuture/react-dev-utils/webpackHotDevClient',
    'src/index',
  ],
  // ...
};
...
```js
const getCSSModuleLocalIdent = require('@tcfuture/react-dev-utils/getCSSModuleLocalIdent');
...
```js
var getCacheIdentifier = require('@tcfuture/react-dev-utils/getCacheIdentifier');

getCacheIdentifier('prod', ['@tcfuture/react-dev-utils', 'chalk']); // # => 'prod:react-dev-utils@5.0.0:chalk@3.0.0'
```
